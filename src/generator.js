...
(function() {
  'use strict';
  var bf, findHoles, findValidTiles, generate, getNeighbors, intersect, randInt, retry, select, simple,
    slice = [].slice;
  ...
  simple = function(board, start) {
    var candidates, i, j, k, l, position, ref, ref1;
